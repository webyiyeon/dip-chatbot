...
retriever_weight = col1.slider(
    "검색 가중치 (높음: 의미 검색, 낮음: 키워드 검색)", min_value=0.0, max_value=1.0, value=0.5, step=0.05
)

chunk_size = col2.number_input(
    "Chunk 사이즈", min_value=100, max_value=2000, value=500, step=10
)
...
# 채팅창 활성화
user_input = st.chat_input("검색할 내용을 입력해주세요.")
